// "Adicionar à agenda" para os e-mails de confirmação do bot: link do Google Agenda +
// conteúdo .ics. Espelho local de packages/shared/src/calendar.ts (o bot não importa
// @haru/shared - mantém mirrors locais, como format.js/email.js). `startIso` é um
// instante UTC e a saída sai em UTC "Z", então o convite cai no horário certo.
