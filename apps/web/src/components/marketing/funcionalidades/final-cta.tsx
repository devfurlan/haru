...
export function FinalCta() {
  return (
    <section className="mx-auto max-w-[1080px] px-[clamp(20px,5vw,40px)] pb-[clamp(56px,7vw,88px)] pt-[clamp(40px,6vw,64px)]">
      <div className="bg-green-deep relative overflow-hidden rounded-[28px] px-[clamp(24px,4vw,48px)] py-[clamp(36px,5vw,60px)] text-center shadow-[0_40px_80px_-40px_rgba(10,51,36,.7)]">
        <div className="pointer-events-none absolute left-[18%] top-[-50px] h-[280px] w-[280px] [background:radial-gradient(circle,rgba(47,211,122,.22),transparent_70%)]" />
        <div className="pointer-events-none absolute bottom-[-70px] right-[12%] h-[300px] w-[300px] [background:radial-gradient(circle,rgba(255,90,54,.16),transparent_70%)]" />
        <div className="relative">
          <h2 className="text-on-emerald mb-[14px] font-serif text-[clamp(28px,5vw,40px)] font-normal leading-[1.12] tracking-[-.02em]">
            Veja tudo isso <span className="text-green-bright italic">funcionando</span>.
          </h2>
