import { ESTETICA } from '@/components/marketing/nicho/content';
import { NicheLanding } from '@/components/marketing/nicho/landing';

export const metadata = {
  title: ESTETICA.metaTitle,
  description: ESTETICA.metaDescription,
};
...
export default function EsteticaPage() {
  return <NicheLanding content={ESTETICA} />;
}
