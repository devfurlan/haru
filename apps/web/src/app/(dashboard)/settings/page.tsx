  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Dados do estabelecimento e integrações.</p>
      </div>

      <TenantCard name={tenant.name} slug={tenant.slug} timezone={tenant.timezone} />
