...
export function SupportCard() {
  return (
    <div className="bg-green-deep text-on-emerald p-4.5 flex flex-wrap items-center gap-3.5 rounded-[18px] bg-[radial-gradient(420px_220px_at_15%_-20%,rgba(47,211,122,.14),transparent_60%)]">
      ...
      <button
        ...
        className="bg-coral flex-none whitespace-nowrap rounded-full px-4 py-3 text-[12.5px] font-semibold text-white shadow-[0_6px_16px_rgba(255,90,54,.3)] transition active:scale-[.97]"
      >
        Chamar o suporte
      </button>
    </div>
