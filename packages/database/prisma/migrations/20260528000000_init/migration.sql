...
CREATE TABLE "Tenant" (
    ...
    "whatsappDisplayPhone" TEXT,
    "notificationWebhookUrl" TEXT,
    "reminderHoursBefore" INTEGER NOT NULL DEFAULT 24,
    "reminderTemplateName" TEXT,
    "reminderTemplateLanguage" TEXT DEFAULT 'pt_BR',
    "cancelTemplateName" TEXT,
    "cancelTemplateLanguage" TEXT DEFAULT 'pt_BR',
    "rescheduleTemplateName" TEXT,
    "rescheduleTemplateLanguage" TEXT DEFAULT 'pt_BR',
...
-- CreateIndex
CREATE INDEX "ScheduleBlock_tenantId_weekday_idx" ON "ScheduleBlock"("tenantId", "weekday");
